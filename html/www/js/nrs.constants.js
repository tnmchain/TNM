...
var NRS = (function (NRS, $) {
    ...
    NRS.processConstants = function(response, resolve) {
        if (response.genesisAccountId) {
            ...
            NRS.constants.COIN_SYMBOL = String("NOR") ;
            $(".coin-symbol").html(NRS.constants.COIN_SYMBOL);
            NRS.constants.ACCOUNT_PREFIX = NRS.constants.COIN_SYMBOL;
            response.ACCOUNT_PREFIX = NRS.constants.COIN_SYMBOL;
            NRS.constants.PROJECT_NAME = "NorChain";
